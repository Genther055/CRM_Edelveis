...
export const Calculator: React.FC = () => {
  ...
  const [rollSubTab, setRollSubTab] = useState<'overview' | 'standard' | 'die_cut' | 'wine' | 'custom'>('overview');
      ...
      {step === 'catalog' ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="ios-card bg-white p-4">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <div style={{ width: '42px', height: '42px', borderRadius: '12px', backgroundColor: 'rgba(0, 122, 255, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--primary)' }}>
                          {wideSubTab === 'banner' && <Layout size={22} />}
                          {wideSubTab === 'film' && <Tag size={22} />}
                          {wideSubTab === 'paper' && <Image size={22} />}
                          {wideSubTab === 'custom' && <Settings size={22} />}
                          {wideSubTab === 'pvc' && <Layers size={22} />}
                          {wideSubTab === 'foam_board' && <FileText size={22} />}
                          {wideSubTab === 'composite' && <ShieldCheck size={22} />}
                          {wideSubTab === 'acrylic' && <Sparkles size={22} />}
                          {wideSubTab === 'canvas' && <Image size={22} />}
                          {wideSubTab === 'stands' && <FolderOpen size={22} />}
                        </div>
                        <div>
                          <h3 className="text-base font-extrabold text-slate-900 m-0">
                            {wideSubTab === 'banner' && 'Банер'}
                          ...
                          <span className="text-xs text-slate-500">
                            {wideSubTab === 'banner' && 'Банерні вивіски, розтяжки, тенти, брандмауери, вітростійка сітка'}
                            {wideSubTab === 'film' && 'Наліпки, плівка для обклеювання вітрин, вивісок, авто, підлогова графіка'}
                            {wideSubTab === 'paper' && 'Афіші, плакати, постери, сітілайти, бігборди, крейдовані постери'}
                            {wideSubTab === 'custom' && 'Замовити прорахунок комплексного або нестандартного замовлення'}
                            {wideSubTab === 'pvc' && 'Таблички, вказівники, вивіски, букви, планшети, ростові фігури'}
                            {wideSubTab === 'foam_board' && 'Легкі виставкові стенди, планшети для презентацій, ростові фігури'}
                            {wideSubTab === 'composite' && 'Фасадні касети, рекламні вивіски високої міцності, таблички'}
                            {wideSubTab === 'acrylic' && 'Номерки, бірки, настінні панелі, фотографії на склі, годинники'}
                            {wideSubTab === 'canvas' && 'Картини на полотні з галерейною натяжкою на підрамник'}
                            {wideSubTab === 'stands' && 'X-banner, L-banner, Roll-up, Прес-вол з конструкцією та полотном'}
                          </span>
                        </div>
                      </div>
                  ...
                  {/* Section: Розмір & Візуалізація виробу */}
                  <div className="ios-card bg-white p-5">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                      <div className="md:col-span-6 flex flex-col gap-4">
                        <h4 className="text-xs font-bold uppercase tracking-wider text-slate-800 m-0 flex items-center gap-2">
                        ...
                        <div>
                          <label className="text-[11px] font-bold text-slate-600 block mb-1.5">Введіть свій індивідуальний розмір:</label>
                          <div className="flex items-center gap-2">
                            <div className="relative flex-1">
                              <input
                                type="number"
                        ...
                        <div className="flex items-center gap-4 text-xs font-bold text-slate-700 bg-slate-50 p-2.5 rounded-xl border border-slate-100">
                          <div>
                      ...
                      {/* Right: Blueprint Visual Preview */}
                      <div className="md:col-span-6 flex flex-col items-center justify-center p-6 bg-gradient-to-b from-slate-50 to-slate-100/60 rounded-2xl border border-slate-200/80 min-h-[190px]">
                        <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400 mb-3">Вид та пропорція макету</span>
                        <div
                          style={{
                            width: `${Math.min(220, Math.max(90, (Number(wideWidth || 2000) / Number(wideHeight || 1000)) * 110))}px`,
                            height: '110px',
                            backgroundColor: '#ffffff',
                            border: '2px solid var(--primary)',
                            borderRadius: '8px',
                  ...
                  <div className="ios-card bg-white overflow-hidden">
                    ...
                    {widePostPressOpen && (
                      <div className="p-5 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3.5 bg-white">
                        ...
                        {(wideSubTab === 'banner' || wideSubTab === 'custom') && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            ...
                            >
                              ...
                              <option value="30cm">Люверси кожні 30 см (по периметру)</option>
                              <option value="50cm">Люверси кожні 50 см (стандарт)</option>
                        ...
                        {(wideSubTab === 'banner' || wideSubTab === 'custom') && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            <label className="text-[11px] font-bold text-slate-600 block mb-1">Підгин (проварка краю):</label>
                            <select
                              value={wideHemming}
                              onChange={(e) => setWideHemming(e.target.value)}
                              className="w-full bg-white border border-slate-200 rounded-lg px-2 py-1 text-xs font-bold text-slate-800"
                            >
                              <option value="perimeter">Проварка по периметру</option>
                              <option value="top_bottom">Тільки верх і низ</option>
                        ...
                        {(wideSubTab === 'banner' || wideSubTab === 'stands' || wideSubTab === 'custom') && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            <label className="text-[11px] font-bold text-slate-600 block mb-1">Кишені під трубу/обтяжувач:</label>
                            <select
                              value={widePocket}
                        ...
                        {(wideSubTab === 'film' || wideSubTab === 'paper' || wideSubTab === 'custom') && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            ...
                            >
                              ...
                              <option value="gloss">Глянцева 1+0</option>
                              <option value="matte">Матова 1+0</option>
                              <option value="floor">Підлогова протиковзка (FloorProtect)</option>
                              <option value="antigraffiti">Антиграфіті захисна</option>
                            </select>
                          </div>
                        )}
                        ...
                        {(wideSubTab === 'film' || wideSubTab === 'custom') && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            ...
                            <select
                              ...
                              className="w-full bg-white border border-slate-200 rounded-lg px-2 py-1 text-xs font-bold text-slate-800"
                            >
                              <option value="0">Без порізки</option>
                              <option value="kiss_cut">Присічка до підкладки (Kiss-Cut)</option>
                              <option value="through_cut">Наскрізна порізка контуру</option>
                            </select>
                          </div>
                        )}

                        {/* Option 6: Монтажна плівка (Film) */}
                        {(wideSubTab === 'film' || wideSubTab === 'custom') && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            <label className="text-[11px] font-bold text-slate-600 block mb-1">Вибірка + Монтажка:</label>
                            <select
                              value={wideMountFilm}
                            ...
                            >
                              <option value="0">Ні</option>
                              <option value="mount">Вибірка облою + Монтажна плівка</option>
                            </select>
                          </div>
                        )}

                        {/* Option 7: Фрезерна різка (PVC / Composite / Acrylic / Foam) */}
                        {(wideSubTab === 'pvc' || wideSubTab === 'composite' || wideSubTab === 'acrylic' || wideSubTab === 'foam_board') && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            <label className="text-[11px] font-bold text-slate-600 block mb-1">Фрезерна різка на ЧПУ:</label>
                            <select
                              value={wideMilling}
                              onChange={(e) => setWideMilling(e.target.value)}
                              className="w-full bg-white border border-slate-200 rounded-lg px-2 py-1 text-xs font-bold text-slate-800"
                            >
                              <option value="0">Прямий різ у розмір</option>
                              <option value="vector">Фігурна фрезеровка по контуру</option>
                            </select>
                          </div>
                        )}

                        {/* Option 8: Дистанційні тримачі (PVC / Acrylic / Composite) */}
                        {(wideSubTab === 'pvc' || wideSubTab === 'composite' || wideSubTab === 'acrylic') && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            <label className="text-[11px] font-bold text-slate-600 block mb-1">Дистанційні кріплення:</label>
                            <select
                              value={wideHolders}
                            ...
                            >
                              ...
                              <option value="gold_4">Золоті металеві (4 шт)</option>
                              <option value="black_4">Чорні матові (4 шт)</option>
                            </select>
                          </div>
                        )}

                        {/* Option 9: Монтажний скотч 3M (PVC / Acrylic / Composite) */}
                        {(wideSubTab === 'pvc' || wideSubTab === 'composite' || wideSubTab === 'acrylic' || wideSubTab === 'foam_board') && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                        ...
                        {/* Option 10: Натяжка на підрамник (Canvas) */}
                        {wideSubTab === 'canvas' && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            ...
                            <select
                              ...
                              className="w-full bg-white border border-slate-200 rounded-lg px-2 py-1 text-xs font-bold text-slate-800"
                            >
                              <option value="gallery">Галерейна натяжка (друк на торцях)</option>
                              <option value="standard">Стандартна натяжка (під багет)</option>
                              <option value="none">Без натяжки (полотно в рулоні)</option>
                            </select>
                          </div>
                        )}

                        {/* Option 11: Арт-гель / Текстурний лак (Canvas) */}
                        {wideSubTab === 'canvas' && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                        ...
                        {/* Option 12: Модель мобільного стенду (Stands) */}
                        {wideSubTab === 'stands' && (
                          <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200/60">
                            ...
                            <select
                              ...
                              className="w-full bg-white border border-slate-200 rounded-lg px-2 py-1 text-xs font-bold text-slate-800"
                            >
                              <option value="rollup_80x200">Roll-Up 80 × 200 см (Касета + чохол)</option>
                              <option value="rollup_100x200">Roll-Up 100 × 200 см (Касета + чохол)</option>
                              <option value="rollup_120x200">Roll-Up 120 × 200 см (Касета + чохол)</option>
                              <option value="spider_60x160">X-banner Павук 60 × 160 см</option>
                              <option value="spider_80x180">X-banner Павук 80 × 180 см</option>
                              <option value="presswall_3x2">Прес-вол 3 × 2 м (Хромована труба)</option>
                            </select>
                          </div>
                        )}
                      </div>
                  ...
                  <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div className="flex flex-col divide-y divide-slate-100">
                        ...
                        <div className="flex-1 p-3.5 flex gap-1.5 flex-wrap items-center">
                          {(wideSubTab === 'banner'
                            ? [
                                ...
                                { id: 'mesh_banner', label: 'Банерна сітка Mesh (вітростійка)' },
                            ...
                            ? [
                                ...
                                { id: 'one_way_vision', label: 'One Way Vision перфорована' },
                                { id: 'translucent', label: 'Світлорозсіювальна транслюцентна' },
                                { id: 'car_cast', label: 'Автомобільна лита (Car Wrap)' }
                              ]
                            : wideSubTab === 'paper'
                            ? [
                                { id: 'citylight_150', label: 'Папір Citylight 150г' },
                                { id: 'blueback_115', label: 'Папір Blueback 115г (бігборди)' },
                                { id: 'photo_satin_200', label: 'Фотопапір Satin 200г' },
                                { id: 'photo_gloss_220', label: 'Фотопапір Gloss 220г' }
                              ]
                            : wideSubTab === 'pvc'
                            ? [
                                { id: 'pvc_3mm', label: 'ПВХ пластик 3 мм' },
                                { id: 'pvc_4mm', label: 'ПВХ пластик 4 мм' },
                                { id: 'pvc_5mm', label: 'ПВХ пластик 5 мм' },
                                { id: 'pvc_8mm', label: 'ПВХ пластик 8 мм' },
                                { id: 'pvc_10mm', label: 'ПВХ пластик 10 мм' }
                              ]
                            : wideSubTab === 'foam_board'
                            ? [
                                { id: 'foam_5mm', label: 'Пінокартон білий 5 мм' },
                                { id: 'foam_10mm', label: 'Пінокартон білий 10 мм' },
                                { id: 'foam_black_5mm', label: 'Пінокартон чорний 5 мм' }
                              ]
                            : wideSubTab === 'composite'
                            ? [
                                { id: 'comp_white_3mm', label: 'Композит білий 3 мм' },
                                { id: 'comp_silver_3mm', label: 'Композит срібло браш 3 мм' },
                                { id: 'comp_black_3mm', label: 'Композит чорний глянець 3 мм' },
                                { id: 'comp_gold_3mm', label: 'Композит золото браш 3 мм' }
                              ]
                            : wideSubTab === 'acrylic'
                            ? [
                                ...
                                { id: 'acryl_black_3mm', label: 'Акрил чорний глянець 3 мм' }
                              ]
                            : wideSubTab === 'canvas'
                            ? [
                                { id: 'canvas_cotton_380', label: 'Натуральне бавовняне полотно 380г' },
                                { id: 'canvas_synthetic_280', label: 'Синтетичне полотно 280г' },
                                { id: 'canvas_gloss_350', label: 'Глянцеве фотополотно 350г' }
                              ]
                            : wideSubTab === 'stands'
                            ? [
                                { id: 'stand_banner_440', label: 'Полотно Frontlit 440г' },
                                { id: 'stand_banner_510', label: 'Полотно Литий Blockout 510г' },
                                { id: 'stand_pp_film', label: 'Полотно PP Film без загину краю' }
                              ]
                            : [
                                { id: 'frontlit_440', label: 'Банер Frontlit 440' },
                                { id: 'oracal_matte', label: 'Плівка самоклейка' },
                                { id: 'pvc_3mm', label: 'Пластик ПВХ 3 мм' }
                              ]
                          ).map(mat => {
                            const isSel = wideSelectedMaterials.includes(mat.id);
                            return (
                              <button
                                key={mat.id}
                                type="button"
                      ...
                      {/* Row 2: Resolution & Print Quality */}
                      <div className="flex flex-col md:flex-row">
                        <div className="w-full md:w-36 bg-slate-50/70 p-3.5 border-b md:border-b-0 md:border-r border-slate-100 text-xs font-bold text-slate-700 uppercase tracking-wider flex items-center">
                          РОЗДІЛЬНІСТЬ:
                        </div>
                        <div className="flex-1 p-3.5 flex gap-1.5 flex-wrap items-center">
                          {[
                            { id: '720', label: '720 dpi — Зовнішній друк (вулиця)' },
                            { id: '1440', label: '1440 dpi — Інтер\'єрний фотоякість' },
                            { id: 'uv_cmyk', label: 'УФ-друк CMYK (стійкий)' },
                            { id: 'uv_white', label: 'УФ CMYK + White (білий шар)' },
                          ].map(res => {
                            const isSel = wideSelectedResolutions.includes(res.id);
                            return (
                              <button
                                key={res.id}
                                type="button"
                                onClick={() => {
                                  setWideSelectedResolutions(prev => 
                                    prev.includes(res.id) ? prev.filter(x => x !== res.id) : [...prev, res.id]
                                  );
                                }}
                                className={`px-2.5 py-1 text-xs font-semibold rounded-lg border transition-all ${
                                  isSel
                      ...
                      <div className="flex flex-col md:flex-row">
                        ...
                        <div className="flex-1 p-3.5 flex gap-1.5 flex-wrap items-center">
                          {[
                            { id: 'clean_cut', label: 'Чистий різ у розмір' },
                            { id: 'luvers_hemming', label: 'Люверси + проклейка' },
                            { id: 'laminated', label: 'З ламінацією' },
                            { id: 'milled', label: 'Фрезеровка по контуру' },
                          ].map(fin => {
                            const isSel = wideSelectedFinishes.includes(fin.id);
                            return (
                              <button
                                key={fin.id}
                                type="button"
                                onClick={() => {
                                  setWideSelectedFinishes(prev => 
                                    prev.includes(fin.id) ? prev.filter(x => x !== fin.id) : [...prev, fin.id]
                                  );
                                }}
                                className={`px-2.5 py-1 text-xs font-semibold rounded-lg border transition-all ${
                                  isSel
          ...
          {mainCategoryTab === 'roll' && (
            <div className="flex flex-col gap-6">
              {/* Roll Sub-Tab Navigation Header */}
              {rollSubTab !== 'overview' ? (
                <div style={{
                  backgroundColor: 'var(--bg-card)',
                  border: '0.5px solid var(--border-light)',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '14px', fontWeight: '700', color: 'var(--text-dark)' }}>
                    <button
                      type="button"
                      onClick={() => setRollSubTab('overview')}
                      style={{ background: 'none', border: 'none', color: 'var(--primary)', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}
                    >
                      <ArrowLeft size={16} />
                      <span>Рулонний друк</span>
                    </button>
                    <span style={{ color: 'var(--text-medium)', opacity: 0.5 }}>/</span>
                    <span style={{ fontWeight: '800' }}>
                      {rollSubTab === 'standard' && 'Стандартна рулонна етикетка'}
                      {rollSubTab === 'die_cut' && 'Фігурна висічка в рулонах'}
                      {rollSubTab === 'wine' && 'Винні та еко-матеріали'}
                      {rollSubTab === 'custom' && 'Індивідуальний розрахунок'}
                    </span>
                  </div>
                  <button
                    type="button"
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <div style={{
                    ...
                    {[
                      { 
                        title: 'Стандартна етикетка', 
                        badge: 'Втулка 76 мм', 
                        desc: 'Етикетки на папері Raflatac та поліпропілені PP для автоматичної та ручної поклейки.', 
                        subTab: 'standard', 
                        icon: <Tag size={28} style={{ color: 'var(--primary)' }} />,
                        metric: 'Флексодрук / Цифра'
                      },
                      { 
                        title: 'Фігурна висічка в рулонах', 
                        badge: 'Контурна висічка', 
                        desc: 'Круглі, овальні та складні фігурні наліпки з індивідуальним штампом або лазером.', 
                        subTab: 'die_cut', 
                        icon: <Scissors size={28} style={{ color: 'var(--primary)' }} />,
                        metric: 'Будь-яка форма'
                      },
                      { 
                        title: 'Винні та еко-матеріали', 
                        badge: 'Фактурний папір', 
                        desc: 'Преміальні матеріали Antique White, Martel та Крафт для пляшок та крафтових виробів.', 
                        subTab: 'wine', 
                        icon: <BookOpen size={28} style={{ color: 'var(--primary)' }} />,
                        metric: 'Еко та фактури'
                      },
                      { 
                        title: 'Індивідуальний розрахунок', 
                        badge: 'Спецпараметри', 
                        desc: 'Нестандартні діаметри шпулі (25/40 мм), White 1+0, лакування та вибірковий друк.', 
                        subTab: 'custom', 
                        icon: <Settings size={28} style={{ color: 'var(--primary)' }} />,
                        metric: 'Конструктор'
                      }
                      ...
                      <div
                        key={item.title}
                        onClick={() => setRollSubTab(item.subTab as any)}
                        className="ios-card"
                        style={{
                          display: 'flex',
                          flexDirection: 'column',
                      ...
                      >
                        <div>
                          ...
                          <p style={{ fontSize: '12px', color: 'var(--text-medium)', lineHeight: '1.45', margin: 0 }}>
                            {item.desc}
                          </p>
                        </div>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <span style={{ fontSize: '14px', color: 'var(--text-medium)' }}>•</span>
                      <h3 style={{
                        fontSize: '13px',
                        fontWeight: '800',
                        color: 'var(--text-dark)',
                  ...
                  <div style={{
                    ...
                    {[
                      {
                        title: 'Етикетка на папері Raflatac',
                        desc: 'Напівглянцевий самоклеючий папір для маркування продукції та упаковки.',
                        icon: <Tag size={26} style={{ color: 'var(--primary)' }} />,
                        badge: 'Raflatac',
                        badgeClass: 'ios-badge-blue',
                        materialId: '209',
                        formats: ['25×25', '30×20', '40×30', '50×50', '58×40', '70×50', '90×50'],
                        metric: 'Напівглянець'
                      },
                      {
                        title: 'Поліпропіленова плівка біла',
                        desc: 'Водостійка біла поліпропіленова етикетка для косметики, побутової хімії та пляшок.',
                        icon: <Layers size={26} style={{ color: '#34c759' }} />,
                        badge: 'Плівка PP',
                        badgeClass: 'ios-badge-green',
                        materialId: '212',
                        formats: ['30×20', '40×30', '50×50', '58×40', '70×50', '100×100'],
                        metric: 'Водостійка'
                      },
                      {
                        title: 'Прозора плівка (No-look)',
                        desc: 'Прозора поліпропіленова самоклейка з опцією друку білим кольором для флаконів.',
                        icon: <Sparkles size={26} style={{ color: '#5856d6' }} />,
                        badge: 'Прозора PP',
                        badgeClass: 'ios-badge-purple',
                        materialId: '213',
                        formats: ['40×30', '50×50', '70×50', '90×50', '100×150'],
                        metric: 'White + CMYK'
                      },
                      {
                        title: 'Металізована плівка срібло',
                        desc: 'Дзеркальний сріблястий поліпропілен для преміальної косметики та елітного алкоголю.',
                        icon: <Zap size={26} style={{ color: '#ff9500' }} />,
                        badge: 'Срібло PP',
                        badgeClass: 'ios-badge-orange',
                        materialId: '214',
                        formats: ['30×20', '50×50', '70×50', '90×50', '100×100'],
                        metric: 'Преміум блиск'
                      },
                      {
                        title: 'Еко-папір Крафт',
                        desc: 'Фактурний бурий крафт-папір для крафтової продукції, кави, свічок та хендмейду.',
                        icon: <FileText size={26} style={{ color: '#8e8e93' }} />,
                        badge: 'Крафт',
                        badgeClass: 'ios-badge-blue',
                        materialId: '210',
                        formats: ['25×25', '40×30', '50×50', '70×50', '90×50'],
                        metric: 'Еко самоклейка'
                      },
                      {
                        title: 'Винний папір Antique White',
                        desc: 'Шляхетний винний папір з благородною текстурою для винних та крафтових пляшок.',
                        icon: <Utensils size={26} style={{ color: '#ff2d55' }} />,
                        badge: 'Antique White',
                        badgeClass: 'ios-badge-red',
                        materialId: '211',
                        formats: ['50×50', '70×50', '90×50', '100×100', '100×150'],
                        metric: 'Винна серія'
                      },
                      {
                        title: 'Винний папір Martel',
                        desc: 'Виразна тиснена структура для ексклюзивних напоїв, авторських олій та делікатесів.',
                        icon: <BookOpen size={26} style={{ color: '#af52de' }} />,
                        badge: 'Martel',
                        badgeClass: 'ios-badge-purple',
                        materialId: '215',
                        formats: ['50×50', '70×50', '90×50', '100×100', '100×150'],
                        metric: 'Фактурний рельєф'
                      },
                      {
                        title: 'Фігурні наліпки (Висічка)',
                        desc: 'Круглі та овальні наліпки в рулонах для брендування та пломбування упаковок.',
                        icon: <Crop size={26} style={{ color: 'var(--primary)' }} />,
                        badge: 'Висічка',
                        badgeClass: 'ios-badge-blue',
                        materialId: '209',
                        formats: ['d 30', 'd 40', 'd 50', 'd 60', '50×30'],
                        metric: 'Фігурна форма'
                      }
                    ].map(prod => (
                      <div
                        key={prod.title}
                        onClick={() => {
                          setRollMaterial(prod.materialId);
                          setRollSubTab('standard');
                        }}
                        className="ios-card bg-white"
                        style={{
                          display: 'flex',
                      ...
                      >
                        <div>
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                            ...
                            <span className={`ios-badge ${prod.badgeClass}`} style={{ fontSize: '10px', padding: '3px 8px' }}>
                              {prod.badge}
                            </span>
                          </div>
                          ...
                          <p style={{ fontSize: '11px', color: 'var(--text-medium)', lineHeight: '1.4', marginBottom: '10px' }}>
                            {prod.desc}
                          </p>
                        ...
                        <div style={{
                          ...
                          <span style={{ fontSize: '10.5px', fontWeight: '600', color: 'var(--text-medium)' }}>
                            {prod.metric}
                          </span>
                          <span style={{ color: 'var(--primary)', display: 'flex', alignItems: 'center', fontSize: '11.5px', fontWeight: '700' }}>
              ...
              {/* DETAILED ROLL PRINTING CALCULATOR (Visible when rollSubTab !== 'overview') */}
              {rollSubTab !== 'overview' && (
                <div className="flex flex-col gap-5">
                  {/* Presentation & Action Bar */}
                  <div className="ios-card bg-white" style={{ padding: '20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                      <div style={{ width: '48px', height: '48px', borderRadius: '14px', backgroundColor: 'rgba(0, 122, 255, 0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--primary)' }}>
                        <Tag size={24} />
                      </div>
                      <div>
                        <h3 style={{ fontSize: '16px', fontWeight: '800', color: 'var(--text-dark)', margin: 0 }}>
                          Калькулятор рулонної етикетки
                        </h3>
                        <p style={{ fontSize: '12px', color: 'var(--text-medium)', margin: '2px 0 0 0' }}>
                          Друк самоклеючихся етикеток на втулках 76 / 40 / 25 мм під автоматичні та ручні аплікатори
                        </p>
                      </div>
                    </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                      {[
                        { id: 'instr_roll', label: 'Інструкція', icon: <FileText size={14} style={{ color: 'var(--primary)' }} /> },
                        { id: 'terms', label: 'Терміни друку', icon: <Clock size={14} style={{ color: 'var(--primary)' }} /> },
                        { id: 'materials', label: 'Матеріали', icon: <Layers size={14} style={{ color: 'var(--primary)' }} /> },
                        { id: 'samples', label: 'Зразки', icon: <Tag size={14} style={{ color: 'var(--primary)' }} /> },
                      ].map(link => (
                        <button
                          key={link.id}
                          type="button"
                  ...
                  {/* 2-Column Setup Grid (Matching Offset/Digital Form Grid) */}
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {/* Left Card: Dimensions & Quantity */}
                    <div className="ios-card bg-white" style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      <h4 style={{ fontSize: '12px', fontWeight: '800', color: 'var(--text-dark)', textTransform: 'uppercase', letterSpacing: '0.5px', margin: 0, borderBottom: '0.5px solid var(--border-light)', paddingBottom: '8px' }}>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex-1 flex items-center bg-slate-50 border border-slate-200 rounded-lg px-3 py-1.5 focus-within:border-blue-500 focus-within:bg-white transition-all">
                            <input
                              type="number"
                              value={rollWidth}
                              ...
                              min="25"
                              max="300"
                              className="w-full bg-transparent text-xs font-bold text-slate-800 outline-none text-center"
                            />
                    ...
                    {/* Right Card: Roll Orientation & Vector SVGs */}
                    <div className="ios-card bg-white" style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      <h4 style={{ fontSize: '12px', fontWeight: '800', color: 'var(--text-dark)', textTransform: 'uppercase', letterSpacing: '0.5px', margin: 0, borderBottom: '0.5px solid var(--border-light)', paddingBottom: '8px' }}>
                        Орієнтація намотки на рулоні
                      </h4>

                      {/* 4 Orientation Selectors */}
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3 flex items-center justify-between flex-wrap gap-3 text-xs mt-auto">
                            <div>
                            ...
                            <div>
                              ...
                              <strong className="text-blue-600 text-sm">{approxRolls} шт (~100м)</strong>
                            </div>
                          </div>
                        );
                      })()}
                  ...
                  {/* Card 2: Materials, Print & Coating Selector (Clean Button Grid Matching Cupertino CRM) */}
                  <div className="ios-card bg-white" style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <h4 style={{ fontSize: '12px', fontWeight: '800', color: 'var(--text-dark)', textTransform: 'uppercase', letterSpacing: '0.5px', margin: 0 }}>
                  ...
                  <div className="ios-card bg-white" style={{ overflow: 'hidden' }}>
                    <div style={{
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold uppercase tracking-wider text-slate-100">
                          Розрахунок вартості та термінів готовності
                        </span>
                      </div>
                      ...
                      <table className="w-full text-center text-xs border-collapse">
                        <thead>
                          <tr className="bg-slate-800 text-slate-200 text-xs font-semibold uppercase tracking-wider border-b border-slate-700">
                            <th className="py-3 px-4 text-left border-r border-slate-700/60">Матеріал та ламінація</th>
                        ...
                        <tbody className="divide-y divide-slate-100">
                          {[
                            ...
                            return (
                              <tr
                                key={row.matId}
                                className={`transition-colors ${isSelectedMat ? 'bg-blue-50/60 font-semibold' : 'hover:bg-slate-50'}`}
                              >
                                  ...
                                  return (
                                    <td
                                      ...
                                      className={`py-2.5 px-3 font-bold border-r border-slate-100 last:border-r-0 hover:bg-blue-600 hover:text-white cursor-pointer transition-all duration-150 ${
                                        isCustomCol ? 'bg-blue-50/80 text-blue-700' : 'text-slate-900'
                                      }`}
                                    >
                                      {displayVal} ₴
                                    </td>
                    ...
                    {(() => {
                      ...
                      const calculatedTotal = Math.round(sqMeters * (baseRate + colorAdd + coatAdd) + 380 + (includeDelivery ? 75 : 0));
                      ...
                      return (
                        <div style={{
                          ...
                          <div className="flex items-center gap-6 flex-wrap text-xs">
                            ...
                            <div>
                              <span className="text-slate-500 block text-[11px]">Кількість рулонів:</span>
                              <strong className="text-blue-600 text-sm">{approxRolls} шт (~100м/рулон)</strong>
                            </div>
                            <div>
                              <span className="text-slate-500 block text-[11px]">Втулка:</span>
                              <strong className="text-slate-800 text-sm">{rollCore} мм (орієнт. №{rollOrientation})</strong>
                            </div>
                          </div>

                          <div className="flex items-center gap-4">
                            <div className="text-right">
                              <span className="text-slate-500 block text-[11px]">Сума до оплати:</span>
